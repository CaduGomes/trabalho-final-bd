...
export default async (db: Connection) => {
  ...
  const addresses = [
    ...
    ["2", "2", "R. Aíres Medeiros de Souza", "Januária", "88960-000", null, "Terminal Rodoviário de Sombrio",], // Sombrio
    ["3", "3", "R. Natalino Teixeira de Rosa", null, "88965-000", "110-210", "Estação Rodoviária de Santa Rosa do Sul",], // Santa Rosa do Sul
    ["4", "4", "Av. Castelo Branco", "Torres", "95560-000", "1853", null], // Torres
    ["5", "5", "R. Osmani Veras", "Centro", "95535-000", "781", null], // Terra da Areia
    ["6", "6", "R. João Cristiano Scheffer Filho", "Centro", "95555-000", "303", null], // Capão da Canoa
